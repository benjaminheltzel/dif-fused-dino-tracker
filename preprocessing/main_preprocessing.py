...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", default="dino-tracker/configs/preprocessing.yaml", help="Config path", type=str)
    ...
    args_list = ['python', 'dino-tracker/preprocessing/extract_trajectories.py', 
    ...
    args_list = ['python', 'dino-tracker/preprocessing/save_dino_embed_video.py', 
    ...
    if not os.path.exists(config['masks_path']):
        ...
        args_list = ['python', 'dino-tracker/preprocessing/create_fg_mask.py', 
    ...
    args_list = ['python', 'dino-tracker/preprocessing/split_trajectories_to_fg_bg.py', 
    ...
    args_list = ['python', 'dino-tracker/preprocessing_dino_bb/main_dino_bb_preprocessing.py', 
