...
if __name__ == "__main__":
    ...
    args_list = ['python', 'dino-tracker/preprocessing_dino_bb/extract_dino_best_buddies.py', 
    ...
    args_list = ['python', 'dino-tracker/preprocessing_dino_bb/of_filter_dino_best_buddies.py',
    ...
    # 4. extract_bb_nms.py
    args_list = ['python', 'dino-tracker/preprocessing_dino_bb/compute_dino_bb_nms.py', 
