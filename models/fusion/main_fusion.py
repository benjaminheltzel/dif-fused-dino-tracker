...
from models.fusion.diffusion_utils import ReshapeCogVideoFeatures, TemporalInterpolator
...
class MainFusion(nn.Module):
    ...
    def forward(self, cogvideo_features, dino_features):
        ...
        print(f"Mean: {dino_features.mean():.4f}")
        print(f"Std: {dino_features.std():.4f}")
